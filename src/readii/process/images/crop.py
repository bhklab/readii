...
def crop_and_resize_image_and_mask(
	image: sitk.Image,
	mask: sitk.Image,
	label: int = 1,
...
if __name__ == "__main__":
	...
	image = read_dicom_auto(
		"tests/4D-Lung/113_HM10395/11-26-1999-NA-p4-13296/1.000000-P4P113S303I10349 Gated 40.0B-29543"
	)

	rois = loadRTSTRUCTSITK(
		rtstructPath="tests/4D-Lung/113_HM10395/11-26-1999-NA-p4-13296/1.000000-P4P113S303I10349 Gated 40.0B-47.35/1-1.dcm",
	...
	centroid_image, centroid_mask = crop_and_resize_image_and_mask(
		image, mask, crop_method="centroid"
	)
