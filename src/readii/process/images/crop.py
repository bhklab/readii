...
def crop_to_centroid(image:sitk.Image,
    ...
    min_x, min_y, min_z, max_x, max_y, max_z = apply_bounding_box_limits(image, 
...
def crop_image_to_mask(image:sitk.Image,
                       mask:sitk.Image,
                       crop_method:Literal["bounding_box", "centroid", "cube"],
                       resize_dimensions:tuple[int,int,int]
                       ) -> sitk.Image:
    """Crop an image to a mask and resize to a specified crop dimensions.
