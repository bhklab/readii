...
def parser():
    ...
    parser.add_argument("--parallel", action="store_false",
                        help="Whether to run feature extraction in a parallel process.")

    parser.add_argument("--update", action="store_true", help="Flag to force rerun all steps of pipeline.")
